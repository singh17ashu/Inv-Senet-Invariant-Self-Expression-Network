...
if args.dataset == "EMNIST":
    ...
    FashionMNIST_train = datasets.FashionMNIST('./datasets', train=True, download=True, transform=transform)
    FashionMNIST_test = datasets.FashionMNIST('./datasets', train=False, download=True, transform=transform)
